...
public final class Constants {
    ...
    public static final String COIN_SYMBOL = "ICBC";
    public static final String ACCOUNT_PREFIX = "ICBC";
    public static final String PROJECT_NAME = "icbc";
    ...
    public static final long MAX_BALANCE_NXT = 20000000000L;
