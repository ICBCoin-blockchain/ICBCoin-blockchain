    ...
    if (colors) {
      switch (type) {
        ...
        case 'header':
          ...
          css +=
            '.header .navbar .nav > li > a:hover, .header .navbar .nav > li > a:focus, .header .navbar .nav > li > a:focus { color: ' +
            colors.link_txt_hover +
        ...
        case 'sidebar':
          ...
          if (colors.sidebar_top_border || colors.sidebar_bottom_border) {
            css +=
              ...
              (colors.sidebar_top_border ? 'border-top: 1px solid ' + colors.sidebar_top_border + '; ' : '') +
              (colors.sidebar_bottom_border ? 'border-bottom: 1px solid ' + colors.sidebar_bottom_border : '') +
              ' }';
          }
          css +=
            '.left-side .sidebar > .sidebar-menu > li > a { background: ' +
            colors.menu_item_bg +
            '; color: ' +
            colors.menu_item_txt +
            (colors.menu_item_top_border ? '; border-top:1px solid ' + colors.menu_item_top_border : '') +
          ...
          css +=
            '.left-side .sidebar > .sidebar-menu > li.active > a { background: ' +
            colors.menu_item_bg_active +
            '; color: ' +
            colors.menu_item_txt_active +
            (colors.menu_item_border_active ? '; border-left: ' + colors.menu_item_border_size + 'px solid ' + colors.menu_item_border_active : '') +
            ' }';
          ...
          css +=
            '.left-side .sidebar > .sidebar-menu > li > a:hover { background: ' +
            colors.menu_item_bg_hover +
            '; color: ' +
            colors.menu_item_txt_hover +
            (colors.menu_item_border_hover ? '; border-left: ' + colors.menu_item_border_size + 'px solid ' + colors.menu_item_border_hover : '') +
            ' }';
          ...
          css +=
            '.sidebar .sidebar-menu .treeview-menu > li > a { background: ' +
            colors.submenu_item_bg +
            '; color: ' +
            colors.submenu_item_txt +
            (colors.submenu_item_top_border ? '; border-top:1px solid ' + colors.submenu_item_top_border : '') +
            (colors.submenu_item_bottom_border ? '; border-bottom: 1px solid ' + colors.submenu_item_bottom_border : '') +
            ' }';
