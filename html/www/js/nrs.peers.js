      ...
      function(response) {
        if (response.peers && response.peers.length) {
          ...
          for (var i = 0; i < response.peers.length; i++) {
            ...
            rows +=
              peer.state == 1
                ? "<span class='round-check'><svg><use xlink:href='img/sprite.svg#check'></use></svg></span>"
                : "<span class='round-error'><svg><use xlink:href='img/sprite.svg#close'></use></svg></span>";
            ...
            rows += '<td>';
            rows += "<a class='btn__dark btn__dark-table--peers' href='#' ";
            ...
            rows += $.t('connect') + '</a>';
            rows += "<a class='btn__dark-border btn__dark-border-peers' href='#' ";
