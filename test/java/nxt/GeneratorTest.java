...
//        try {
//            while (i<deadline) {
//                Assert.assertFalse(generator.forge(lastBlock, lastBlock.getTimestamp() + i, balanse));
//                i += 100;
//            }
//            Assert.assertEquals(true, generator.forge(lastBlock, (int)hitTime + 1, balanse));
