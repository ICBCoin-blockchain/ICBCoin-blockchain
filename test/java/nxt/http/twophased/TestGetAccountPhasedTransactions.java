...
public class TestGetAccountPhasedTransactions extends BlockchainTest {
    ...
    public void simpleOutgoingLookup() {
        ...
        Assert.assertTrue(TwoPhasedSuite.searchForTransactionId(transactionsJson, String.valueOf(transactionJSON.get("transaction"))));

        response = phasedTransactionsApiCall(CHUCK.getId()).invoke();
        Logger.logMessage("getAccountPhasedTransactionsResponse:" + response.toJSONString());
        transactionsJson = (JSONArray) response.get("transactions");
        Assert.assertFalse(TwoPhasedSuite.searchForTransactionId(transactionsJson, String.valueOf(transactionJSON.get("transaction"))));
    }
    ...
    public void multiple() {
        ...
        Assert.assertTrue(TwoPhasedSuite.searchForTransactionId(transactionsJson, String.valueOf(transactionJSON1.get("transaction"))));
        Assert.assertTrue(TwoPhasedSuite.searchForTransactionId(transactionsJson, String.valueOf(transactionJSON2.get("transaction"))));
    }
