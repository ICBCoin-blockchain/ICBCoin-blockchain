...
public class TestTrustlessAssetSwap extends BlockchainTest {
    ...
    public void assetSwap() {
        ...
        String aliceAssetId = String.valueOf(aliceAsset.get("transaction"));
        ...
        String aliceTransferFullHash = String.valueOf(aliceSignedTransfer.get("fullHash"));
        Assert.assertEquals(64, aliceTransferFullHash.length());
        String aliceTransferTransactionBytes = String.valueOf(aliceSignedTransfer.get("transactionBytes"));
        ...
        String bobAssetId = String.valueOf(bobAsset.get("transaction"));
        ...
        JSONObject bobTransferValidation = new APICall.Builder("getTransaction").
                param("transaction", String.valueOf(bobTransfer.get("transaction"))).
                build().invoke();
