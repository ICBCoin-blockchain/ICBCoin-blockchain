...
public class SendMessageTest extends BlockchainTest {
    ...
    public void sendMessage() {
        ...
        String transaction = String.valueOf(response.get("transaction"));
    ...
    public void sendEncryptedMessage() {
        ...
        Assert.assertNotEquals(64, (String.valueOf(encryptedMessage.get("data"))).length());
        Assert.assertNotEquals(32, (String.valueOf(encryptedMessage.get("nonce"))).length());
        generateBlock();
        response = new APICall.Builder("readMessage").
                param("secretPhrase", BOB.getSecretPhrase()).
                param("transaction", transaction).
    ...
    public void sendClientEncryptedMessageToSelf() {
        ...
        Assert.assertEquals(64, (String.valueOf(encryptedMessage.get("nonce"))).length());
        generateBlock();
        response = new APICall.Builder("readMessage").
                param("secretPhrase", ALICE.getSecretPhrase()).
                param("transaction", transaction).
