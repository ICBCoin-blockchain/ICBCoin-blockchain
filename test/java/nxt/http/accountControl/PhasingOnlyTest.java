...
public class PhasingOnlyTest extends BlockchainTest {
    ...
    public void testAccountVoting() throws Exception {
      ...
      //incorrect quorum - even if more restrictive, should also be blocked
        ...
        String fullHash = String.valueOf(removePhasingOnlyJSON.get("fullHash"));
    ...
    public void testExtraRestrictions() throws Exception {
        ...
        String fullHash = String.valueOf(response.get("fullHash"));
        ...
        fullHash = String.valueOf(response.get("fullHash"));
        generateBlock();
    ...
    public void testRejectingPendingTransaction() throws Exception {
        ...
        String fullHash = String.valueOf(sendMoneyJSON.get("fullHash"));
    ...
    public void testAssetVoting() {
        ...
        String assetId = String.valueOf(ACTestUtils.assertTransactionSuccess(builder).get("transaction"));
        generateBlock();
        
        builder = new ACTestUtils.AssetBuilder(ALICE.getSecretPhrase(), "TestAsset2");
        String asset2Id = String.valueOf(ACTestUtils.assertTransactionSuccess(builder).get("transaction"));
        generateBlock();
    ...
    public void testCurrencyVoting() {
        ...
        String currencyId = String.valueOf(ACTestUtils.assertTransactionSuccess(builder).get("transaction"));
        generateBlock();
        
        builder = new ACTestUtils.CurrencyBuilder().naming("testb", "TESTB", "Test AC");
        String currency2Id = String.valueOf(ACTestUtils.assertTransactionSuccess(builder).get("transaction"));
        generateBlock();
