...
public class TestShuffling extends BlockchainTest {
    ...
    public void successfulShuffling() {
        ...
        String shufflingId = String.valueOf(shufflingCreate.get("transaction"));
        String shufflingFullHash = String.valueOf(shufflingCreate.get("fullHash"));
        generateBlock();
        ...
        String shufflingAssignee = String.valueOf(getShufflingResponse.get("assignee"));
        ...
        String shufflingStateHash = String.valueOf(getShufflingResponse.get("shufflingStateHash"));
        ...
        shufflingAssignee = String.valueOf(getShufflingResponse.get("assignee"));
